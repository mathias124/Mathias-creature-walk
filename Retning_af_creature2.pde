...
float eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5;//rettet så den kører på float, da kommatal er vigtig så de ikke runder op og går ind mod centrum.
float   eyeRightRelativeX = 20  ,  eyeRightRelativeY = 5;   //rettet så den kører på float, da kommatal er vigtig så de ikke runder op og går ind mod centrum.
...
void draw() {                         
  ...
  clear();
  ellipse(ballX, ballY, ballSize, ballSize);//krop
  ellipse(eyeLeftRelativeX + ballX, eyeLeftRelativeY + ballY, eyeSize,eyeSize);//venstre øje ellipse(cirkel)
  ellipse(eyeRightRelativeX + ballX, eyeRightRelativeY + ballY, eyeSize,eyeSize);//højre øje
}
